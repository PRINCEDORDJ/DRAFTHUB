...
const AlertModal = ({isOpen, onConfirm, onClose, title, message}) => {
  return (
    <div className="bg-black/50 backdrop-blur-md fixed top-0 left-0 w-full h-screen py-50 px-2 " onClick={()=>isOpen(false)}>
      <div className="bg-slate-500 flex flex-col items-center py-10 rounded-lg">
        <div>
